...
You can also view the [**HTML (Notebook Export)**](https://github.com/Maged325/Python-Portfolio/blob/main/Seaborn/Seaborn.html) version for a clean, interactive look without running the code.
